...
class AddSharedMemoryPage extends StatefulWidget {
  final String currentUserId;
  final String characterId;

  const AddSharedMemoryPage({
    super.key,
  ...
  @override
  State<AddSharedMemoryPage> createState() =>
      _AddSharedMemoryPageState();
}

class _AddSharedMemoryPageState extends State<AddSharedMemoryPage> {
