...
class CustomSceneEditPage extends StatefulWidget {
  ...
  @override
  State<CustomSceneEditPage> createState() => _CustomSceneEditPageState();
}

class _CustomSceneEditPageState extends State<CustomSceneEditPage> {
  ...
  void _showMessage(String message) {
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(
        SnackBar(
          content: Text(message, style: GoogleFonts.notoSerifTc()),
        ),
      );
  }
